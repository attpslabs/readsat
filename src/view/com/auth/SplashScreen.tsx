    ...
    <>
      ...
      <Animated.View
        ...
        <View
          ...
          <Logo width={150} fill={styles.logoFill} style={styles.logoShadow} />
        </View>
        ...
        <View
          ...
          <View
            ...
            <Button
              ...
              accessibilityHint={_(
                msg`Opens flow to create a new Reads account`,
              )}
              size="large"
          ...
          <Button
            ...
            label={_(msg`Sign in`)}
            accessibilityHint={_(
              msg`Opens flow to sign in to your existing Reads account`,
            )}
            size="large">
